...
ERoadModuleTraceResult UGearStatics::TraceRoadModule(UObject* WorldContextObject, TSubclassOf<class AGearRoadModule> RoadModuleClass, const FTransform& SocketTransform)
{
	...
	DrawDebugBox(WorldContextObject->GetWorld(), ColliderPos, RoadModule->MainCollider->GetUnscaledBoxExtent(), ColliderRot, bHitMainBody ? FColor::Blue : FColor::Red, false, 0.1f);
#endif
...
#if !UE_BUILD_SHIPPING
	DrawDebugBox(WorldContextObject->GetWorld(), ColliderPos, RoadModule->MainCollider->GetUnscaledBoxExtent(), ColliderRot, bHitMainBody ? FColor::Yellow : FColor::Red, false, 0.1f);
#endif
